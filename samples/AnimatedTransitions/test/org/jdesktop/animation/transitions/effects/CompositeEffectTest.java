...
public final class CompositeEffectTest
{
   ...
   @Test
   public void init(@Mocked final Animator animator, @Mocked final Effect anyEffect)
   {
      composite.addEffect(effect1);
      composite.addEffect(effect2);
   ...
   @Test
   public void cleanup(@Mocked final Animator animator, @Mocked Effect anyEffect)
   {
      composite.addEffect(effect1);

      composite.cleanup(animator);

      new Verifications() {{ onInstance(effect1).cleanup(animator); }};
   }
