...
public final class EffectTest
{
   ...
   @Test
   public void initEffectWithStartStateAndOutdatedComponentImage(@Mocked final Image image)
   {
   ...
   @Test
   public void cleanupDoesNothing(@Mocked Animator animator)
   {
   ...
   @Test
   public void initEffectWithEndStateAndUpToDateComponentImage(@Mocked final Image image)
   {
