...
public final class MessageTest
{
   ...
   @Test
   public void sendMessageToMultipleClients(@Mocked final StatusListener listener) throws Exception
   {
      ...
      new NonStrictExpectations(testClients.length) {
         @Mocked final Socket con = new Socket(withPrefix("client"), anyInt);
   ...
   @Test
   public void sendMessageToMultipleClients_minimal(@Mocked final StatusListener listener) throws Exception
   {
