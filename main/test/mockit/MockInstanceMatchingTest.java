...
public final class MockInstanceMatchingTest
{
   ...
   public void declaringNonStrictMockedTypeImpliesNonStrictnessForOtherMocksOfSameTypeAsWell(
      @Mocked final Collaborator mock1, @NonStrict Collaborator mock2)
   {
   ...
   @Test
   public void declaringNonStrictMockedTypeImpliesNonStrictnessForOtherMocksOfSameTypeAsWell2(
      @Mocked final Collaborator mock1)
   {
      new Expectations() {
   ...
   public void recordAllowedConstructorInvocationForMockedTypeWithBothStrictAndNonStrictMocks(
      @NonStrict Collaborator mock1, @Mocked final Collaborator mock2)
   {
      new Expectations() {{
         mock2.setValue(2);
         new Collaborator();
