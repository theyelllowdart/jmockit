...
public final class ForEachInvocationTest
{
   ...
   public void recordExpectationWithHandlerThatWillValidateMultipleInvocations(@Mocked final Collaborator mock)
   {
   ...
   @Test(expected = AssertionError.class)
   public void verifyExpectationWithHandlerThatValidatesMultipleInvocations(@Mocked final Collaborator mock)
   {
      mock.doSomething(true, 5); // valid
   ...
   @Test
   public void recordExpectationForMultiParameterMethodWithHandlerHavingNoParameters(@Mocked final Collaborator mock)
   {
      new NonStrictExpectations() {{
   ...
   @Test
   public void verifyExpectationsWithHandlersForEachInvocation(@Mocked final Collaborator mock)
   {
      Collaborator collaborator = new Collaborator();
   ...
   @Test
   public void combineDelegateAndValidationObjects(@Mocked final Collaborator collaborator)
   {
      new NonStrictExpectations() {{
   ...
   @Test
   public void verifyExpectationWithHandlerForEachInvocationOfConstructor(@Mocked Collaborator mock)
   {
   ...
   @Test(expected = AssertionError.class)
   public void verifyExpectationWithHandlerWhichFailsAssertion(@Mocked Collaborator mock)
   {
      new Collaborator(0);
   ...
   @Test
   public void verifyExpectationsOnStaticMethodsWithHandlers(@Mocked Collaborator unused)
   {
   ...
   @Test
   public void verifyExpectationWithHandlerForNativeMethod(@Mocked final Collaborator mock)
   {
   ...
   @Test
   public void recordExpectationWithHandlerForFinalMethod(@Mocked final Collaborator mock)
   {
      new NonStrictExpectations() {{
   ...
   @Test
   public void verifyExpectationWithHandlerForPrivateMethod(@Mocked final Collaborator collaborator)
   {
   ...
   @Test
   public void recordExpectationWithHandlerDefiningTwoMethods(@Mocked final Collaborator collaborator)
   {
      new NonStrictExpectations() {{
         collaborator.doSomething(true, null, "str");
         forEachInvocation = new Object() {
            void validator(boolean b, int[] i, String s) { assertTrue(b); }
   ...
   @Test
   public void verifyExpectationWithHandlerDefiningTwoNonPrivateMethods(@Mocked final Collaborator collaborator)
   {
      collaborator.doSomething(true, null, "str");
   ...
   @Test
   public void recordExpectationWithHandlerMissingNonPrivateMethod(@Mocked final Collaborator collaborator)
   {
      new NonStrictExpectations() {{
         collaborator.doSomething(true, null, "str");
   ...
   public void handlerForFailedUnorderedVerification(@Mocked final Collaborator mock)
   {
      mock.doSomething();
   ...
   public void handlerForFailedOrderedVerification(@Mocked final Collaborator mock)
   {
      mock.doSomething();
   ...
   @Test
   public void verifyExpectationsInOrderWithHandlerForMultipleInvocations(@Mocked final Collaborator mock)
   {
      mock.doSomething(1);
      mock.doSomething(2);
      mock.doSomething(3);
   ...
   @Test
   public void verifyUnorderedExpectationsWithHandlerForMultipleInvocations(@Mocked final Collaborator mock)
   {
      mock.doSomething(1);
      mock.doSomething(2);
      mock.doSomething(3);
   ...
   @Test
   public void verifyExpectationWithHandlerWhichDefinesInvocationParameter(@Mocked final Collaborator mock)
   {
      mock.doSomething(1);
      mock.doSomething();
      mock.doSomething(2);
   ...
   @Test
   public void verifyInvocationsWithHandlersHavingAlsoRecordedExpectations(@Mocked final Collaborator mock)
   {
      new NonStrictExpectations() {{
         mock.doSomething(anyInt);
   ...
   @Test(expected = AssertionError.class)
   public void recordInvocationsWithBooleanReturningHandler(@Mocked final Collaborator mock)
   {
      new NonStrictExpectations() {{
         mock.doSomething(anyInt);
   ...
   @Test(expected = AssertionError.class)
   public void recordAllInvocationsInOrderWithBooleanReturningHandler(@Mocked final Collaborator mock)
   {
      new Expectations() {{
   ...
   @Test(expected = AssertionError.class)
   public void verifyInvocationsWithBooleanReturningHandler(@Mocked final Collaborator mock)
   {
      mock.doSomething(5);
      mock.doSomething(-5);
   ...
   @Test(expected = AssertionError.class)
   public void verifyAllInvocationsWithBooleanReturningHandler(@Mocked final Collaborator mock)
   {
   ...
   @Test(expected = AssertionError.class)
   public void verifyInvocationsInOrderWithBooleanReturningHandler(@Mocked final Collaborator mock)
   {
   ...
   @Test(expected = AssertionError.class)
   public void verifyAllInvocationsInOrderWithBooleanReturningHandler(@Mocked final Collaborator mock)
   {
      mock.doSomething(true, new int[0], "test1");
   ...
   @Test
   public void reusableInvocationCounter(@Mocked final Collaborator mock)
   {
      mock.doSomething(1);
   ...
   @Test
   public void reusableVerificationsWithInvocationCounter(@Mocked final Collaborator mock)
   {
      mock.doSomething(1);
      mock.doSomething(true, 1);
      mock.doSomething(2);
