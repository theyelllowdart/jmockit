...
public final class VerificationsWithLocalFieldsTest
{
   ...
   {
      new NonStrictExpectations() {
         @Mocked final Dependency mock = new Dependency(5);
      };
   ...
   {
      Expectations exp = new NonStrictExpectations() {
   ...
   public void importMocksFromMultipleExpectationBlocks()
   {
      ...
      new NonStrictExpectations() { @Mocked Dependency mock; };
      new NonStrictExpectations() {
         @Mocked SubDependency mock;
   ...
   @Test
   public void importMocksFromExpectationBlocksWhereTheFirstHasNoMockFields(@Mocked final SubDependency sub)
   {
   ...
   {
      new NonStrictExpectations() {
         @Mocked Callable<Dependency> mock;
