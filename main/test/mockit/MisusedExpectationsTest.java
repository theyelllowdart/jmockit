...
public final class MisusedExpectationsTest
{
   ...
   @Test
   public void accessSpecialFieldsInExpectationBlockThroughClassQualifierInsteadOfDirectly(@Mocked final BlahBlah mock)
   {
      new NonStrictExpectations() {{
   ...
   @SuppressWarnings("StaticFieldReferencedViaSubclass")
   @Test
   public void accessSpecialFieldsInVerificationBlockThroughClassQualifierInsteadOfDirectly(@Mocked final BlahBlah mock)
   {
