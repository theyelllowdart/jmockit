...
public final class InstanceSpecificMockingTest
{
   ...
   @Test
   public void allowInjectableMockOfEnumType(@Injectable final EnumWithMethod mock)
   {
      new Expectations() {{ mock.someMethod(); result = 45; }};

      assertEquals(45, mock.someMethod());
   }
