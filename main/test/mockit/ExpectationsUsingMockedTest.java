...
public final class ExpectationsUsingMockedTest
{
   ...
   @Test
   public void annotatedFieldAndParameter(@Mocked final Dependency dependency1)
   {
      new NonStrictExpectations() {
         @Mocked private Dependency dependency2;
   ...
   {
      new Expectations() {
         @Mocked(value = "", stubOutClassInitialization = true) final ClassWithStaticInitializer unused = null;
      };
   ...
   {
      new Expectations() {
         @Mocked final AnotherClassWithStaticInitializer unused = null;
      };
