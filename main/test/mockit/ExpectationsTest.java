...
public final class ExpectationsTest
{
   ...
   @Test(expected = UnexpectedInvocation.class)
   public void expectNothingOnTestScopedMockedTypeButExerciseItDuringReplay(@Mocked final Collaborator mock)
   {
      new Expectations() {{
   ...
   {
      new Expectations() {
         @Mocked final Collaborator mock = new Collaborator();
   ...
   {
      new Expectations() {
         @Mocked final SubCollaborator mock = new SubCollaborator();
   ...
   @Test
   public void mockSuperClassUsingMockParameter(@Mocked final Collaborator mock)
   {
      new Expectations() {{
   ...
   public void mockClassWithMethodsOfAllReturnTypesReturningDefaultValues()
   {
      ...
      new Expectations() {
         @Mocked ClassWithMethodsOfEveryReturnType mock;
   ...
   public void mockNativeMethod(@Mocked System system)
   {
      new Expectations() {{
